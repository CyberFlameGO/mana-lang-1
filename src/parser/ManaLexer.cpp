...
void ManaLexer::action(RuleContext *context, size_t ruleIndex, size_t actionIndex) {
  switch (ruleIndex) {
...
bool ManaLexer::sempred(RuleContext *context, size_t ruleIndex, size_t predicateIndex) {
  switch (ruleIndex) {
...
void ManaLexer::FooAction(antlr4::RuleContext *context, size_t actionIndex) {
  switch (actionIndex) {
...
void ManaLexer::BarAction(antlr4::RuleContext *context, size_t actionIndex) {
  switch (actionIndex) {
...
bool ManaLexer::FooSempred(antlr4::RuleContext *_localctx, size_t predicateIndex) {
...
bool ManaLexer::BarSempred(antlr4::RuleContext *_localctx, size_t predicateIndex) {
  switch (predicateIndex) {
